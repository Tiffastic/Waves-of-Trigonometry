...
public class AnimationWindow extends JFrame implements ActionListener
{
	...
	public static void main (String[] args)
	{
		...
		g.setExtendedState(g.MAXIMIZED_BOTH);
		g.setVisible(true);
	}
	...
	{
		setTitle("CS 1410 Graphics Animation - Waving Through Time by Thuy Nguyen");
		setDefaultCloseOperation(DISPOSE_ON_CLOSE);
		
		timer = new Timer(REFRESH_RATE, this);
		area = new DrawingArea();
		start = new JButton("Start the Waves of Time");
	...
	public void actionPerformed (ActionEvent e)
	{
		...
		else if (start.getText().equals("Start the Waves of Time"))
		{
			synchronized (area)
			{
				area.clearTimer();
